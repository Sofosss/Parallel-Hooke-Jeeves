...
colors = ["forestgreen",  "darkorange", "midnightblue"]
...
fig, ax = plt.subplots(figsize = (8.5, 4.7), dpi = 600)
...
ax.set_xticks(np.arange(len(MPI_RANKS))); ax.set_xticklabels(MPI_RANKS, fontsize = 18)
...
ax.legend(handles = handles, labels = labels,
                           ...
                           ncols = 1, framealpha = 1.0, shadow = True, fontsize = 12.5, labelspacing = 0.4, 
                           columnspacing = 1.02, bbox_to_anchor = (0.005, 1.008))
